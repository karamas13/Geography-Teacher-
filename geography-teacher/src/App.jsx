...
const App = () => {
  ...
  const PlaceAutocomplete = ({ onPlaceSelect }) => {
    ...
    return (
      <div className="autocomplete-container" >
        <input className='p-2 rounded-lg bg-[#333] text-white' ref={inputRef} />
      </div>
    );
  };
  ...
  return (
    ...
    <div className="mb-4 flex flex-row items-center justify-center w-full">
      ...
      <h1 className="text-3xl lg:text-4xl font-bold text-white">Geography Teacher</h1>
    </div>
    ...
    >
      <Map
        ...
        className='h-[92vh] w-[100em] mx-auto'
        minZoom={2}
      >
        <AdvancedMarker ref={markerRef} position={null} />
      </Map>
      <MapControl position={ControlPosition.TOP} className="rounded-lg p-2">
        <div className="autocomplete-control m-3 text-xl p-2 mx-auto">
